...
public class PasserelleServiceWebXMLTestGuillaume {
	...
	public void testEnvoyerPosition() throws ParseException {
		...
		String msg = PasserelleServicesWebXMLGuillaume.envoyerPosition("europa", Outils.sha1("mdputilisateurrrrrr"), lePoint);
		assertEquals("Erreur : authentification incorrecte.", msg);
